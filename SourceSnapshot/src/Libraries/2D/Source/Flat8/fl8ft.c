...
void (*flat8_function_table[GRD_FILL_TYPES][GRD_FUNCS * REAL_BMT_TYPES])() = {
    {/* normal fill type - from fl8nft.h */
     ...
     (ptr_type)flat8_flat8_ubitmap,    /* bitmap blitter */
     (ptr_type)gri_flat8_mask_bitmap,  /* stencil clipped bitmap blitter */
     (ptr_type)gri_flat8_clut_ubitmap, /* clut bitmap blitter */
     ...
     (ptr_type)gri_trans_scale_umap_init, gr_null, gr_null, (ptr_type)gri_opaque_clut_scale_umap_init,
     (ptr_type)gri_trans_clut_scale_umap_init,

     (ptr_type)gri_cpoly_init, /* RGB polygon primitives */
     (ptr_type)gri_trans_blend_clut_lin_umap_init,

     (ptr_type)gr_not_imp, //### MLA- not supposed to be used   (ptr_type)
     // gri_opaque_true_lin_umap_init,   /* Linear mappers
     //*/
     gr_null, gr_null, gr_null,
     (ptr_type)gr_not_imp, //### MLA- not supposed to be used   (ptr_type)
                           // gri_opaque_clut_true_lin_umap_init,
     gr_null,

     (ptr_type)gri_opaque_lin_umap_init, /* Bilinear */
     (ptr_type)gri_trans_lin_umap_init, (ptr_type)gri_opaque_lit_lin_umap_init, (ptr_type)gri_trans_lit_lin_umap_init,
     (ptr_type)gri_opaque_clut_lin_umap_init, (ptr_type)gri_trans_clut_lin_umap_init,

     (ptr_type)gri_opaque_floor_umap_init, /* Floor */
     (ptr_type)gri_trans_floor_umap_init, (ptr_type)gri_opaque_lit_floor_umap_init,
     (ptr_type)gri_trans_lit_floor_umap_init, (ptr_type)gri_opaque_clut_floor_umap_init,
     (ptr_type)gri_trans_clut_floor_umap_init,

     (ptr_type)gri_opaque_wall_umap_init, /* Wall2d */
     (ptr_type)gri_trans_wall_umap_init, (ptr_type)gri_opaque_lit_wall_umap_init,
     (ptr_type)gri_trans_lit_wall_umap_init, (ptr_type)gri_opaque_clut_wall_umap_init,
     (ptr_type)gri_trans_clut_wall_umap_init,

     (ptr_type)gri_opaque_wall_umap_init, /* Wall1d */
     (ptr_type)gri_trans_wall_umap_init, (ptr_type)gri_opaque_lit_wall1d_umap_init,
     (ptr_type)gri_trans_lit_wall_umap_init, (ptr_type)gri_opaque_clut_wall1d_umap_init,
     (ptr_type)gri_trans_clut_wall_umap_init,

     (ptr_type)gri_opaque_per_umap_hscan_init, /* Perspective -hscan */
     (ptr_type)gri_trans_per_umap_hscan_init, (ptr_type)gri_opaque_lit_per_umap_hscan_init,
     (ptr_type)gri_trans_lit_per_umap_hscan_init, (ptr_type)gri_opaque_clut_per_umap_hscan_init,
     (ptr_type)gri_trans_clut_per_umap_hscan_init,

     (ptr_type)gri_opaque_per_umap_vscan_init, /* Perspective -vscan */
     (ptr_type)gri_trans_per_umap_vscan_init, (ptr_type)gri_opaque_lit_per_umap_vscan_init,
     ...
     (ptr_type)gri_flat8_rsd8_ubitmap, /* bitmap blitter */
     (ptr_type)gri_flat8_rsd8_bitmap,  /* stencil clipped bitmap blitter */
     gr_null,                          /* clut bitmap blitter */
     ...
     (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init, (ptr_type)rsd8_tm_init,
     ...
     (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init, (ptr_type)rsd8_pm_init,
     ...
     (ptr_type)flat8_tluc8_ubitmap, /* bitmap blitter */
     gr_null,                       /* stencil clipped bitmap blitter */
     gr_null,                       /* clut bitmap blitter */
     ...
     (ptr_type)gri_tluc8_trans_scale_umap_init, gr_null, gr_null, (ptr_type)gri_tluc8_opaque_clut_scale_umap_init,
     ...
     (ptr_type)gri_tluc8_trans_lin_umap_init, gr_null, gr_null, (ptr_type)gri_tluc8_opaque_clut_lin_umap_init,
    ...
    {/* clut fill type - from fl8cft.h */
     ...
     (ptr_type)gri_trans_clut_scale_umap_init, (ptr_type)gri_opaque_clut_scale_umap_init,
     (ptr_type)gri_trans_clut_scale_umap_init, (ptr_type)gri_opaque_clut_scale_umap_init,
     (ptr_type)gri_trans_clut_scale_umap_init,
     ...
     (ptr_type)gr_not_imp,
     //### MLA- not supposed to be used
     // gri_opaque_clut_true_lin_umap_init,   /* Linear mappers */
     gr_null, gr_null, gr_null, (ptr_type)gr_not_imp,
     //### MLA- not supposed to be used
     // gri_opaque_clut_true_lin_umap_init,
     gr_null,

     (ptr_type)gri_opaque_clut_lin_umap_init, /* Bilinear */
     (ptr_type)gri_trans_clut_lin_umap_init, (ptr_type)gri_opaque_clut_lin_umap_init,
     (ptr_type)gri_trans_clut_lin_umap_init, (ptr_type)gri_opaque_clut_lin_umap_init,
     ...
     (ptr_type)gri_trans_clut_wall_umap_init, (ptr_type)gri_opaque_clut_wall_umap_init,
     (ptr_type)gri_trans_clut_wall_umap_init, (ptr_type)gri_opaque_clut_wall_umap_init,
     (ptr_type)gri_trans_clut_wall_umap_init,
     ...
     (ptr_type)gri_trans_clut_per_umap_hscan_init, (ptr_type)gri_opaque_clut_per_umap_hscan_init,
     (ptr_type)gri_trans_clut_per_umap_hscan_init, (ptr_type)gri_opaque_clut_per_umap_hscan_init,
     (ptr_type)gri_trans_clut_per_umap_hscan_init,
     ...
     (ptr_type)gri_tluc8_trans_clut_lin_umap_init, (ptr_type)gri_tluc8_opaque_clut_lin_umap_init,
     (ptr_type)gri_tluc8_trans_clut_lin_umap_init, (ptr_type)gri_tluc8_opaque_clut_lin_umap_init,
     (ptr_type)gri_tluc8_trans_clut_lin_umap_init,
    ...
    {/* xor fill type - from fl8xft.h */
     ...
     gr_null, /* Perspective -vscan */
     gr_null, gr_null, gr_null, gr_null, gr_null},
    {/* blend fill type - from fl8bft.h */
     /* FILL_NORM */
     /* BMT_DEVICE */
     (ptr_type)flat8_blend_set_upixel, /* pixel primitve */
     gr_null,                          /* reserved wire poly line */
     gr_null,                          /* solid hline */
    ...
    {/* solid fill type - from fl8sft.h */
     ...
     (ptr_type)gri_trans_solid_scale_umap_init, (ptr_type)gri_opaque_solid_scale_umap_init,
     (ptr_type)gri_trans_solid_scale_umap_init, (ptr_type)gri_opaque_solid_scale_umap_init,
     ...
     gr_null, (ptr_type)gri_solid_poly_init, gr_null, (ptr_type)gri_solid_poly_init, gr_null,

     (ptr_type)gri_solid_poly_init, /* Bilinear */
     (ptr_type)gri_trans_solid_lin_umap_init, (ptr_type)gri_solid_poly_init, (ptr_type)gri_trans_solid_lin_umap_init,
     (ptr_type)gri_solid_poly_init, (ptr_type)gri_trans_solid_lin_umap_init,

     (ptr_type)gri_solid_poly_init, /* Floor */
     (ptr_type)gri_trans_solid_floor_umap_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)gri_trans_solid_floor_umap_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)gri_trans_solid_floor_umap_init,

     (ptr_type)gri_solid_poly_init, /* Wall2d */
     (ptr_type)gri_trans_solid_wall_umap_init, (ptr_type)gri_solid_poly_init, (ptr_type)gri_trans_solid_wall_umap_init,
     (ptr_type)gri_solid_poly_init, (ptr_type)gri_trans_solid_wall_umap_init,
     ...
     (ptr_type)gri_trans_solid_per_umap_hscan_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)gri_trans_solid_per_umap_hscan_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)gri_trans_solid_per_umap_hscan_init,

     (ptr_type)gri_solid_poly_init, /* Perspective -vscan */
     (ptr_type)gri_trans_solid_per_umap_vscan_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)gri_trans_solid_per_umap_vscan_init, (ptr_type)gri_solid_poly_init,
     ...
     (ptr_type)gri_opaque_solid_scale_umap_init, (ptr_type)rsd8_tm_init, (ptr_type)gri_opaque_solid_scale_umap_init,
     (ptr_type)rsd8_tm_init, (ptr_type)gri_opaque_solid_scale_umap_init, (ptr_type)rsd8_tm_init,

     (ptr_type)gri_solid_poly_init, /* shaded translucent polygon primitives */
     gr_null,

     (ptr_type)gri_solid_poly_init, /* Linear mappers */
     (ptr_type)rsd8_tm_init, (ptr_type)gri_solid_poly_init, (ptr_type)rsd8_tm_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)rsd8_tm_init,
     ...
     (ptr_type)gri_solid_poly_init, /* Perspective -hscan */
     (ptr_type)rsd8_pm_init, (ptr_type)gri_solid_poly_init, (ptr_type)rsd8_pm_init, (ptr_type)gri_solid_poly_init,
     (ptr_type)rsd8_pm_init,
