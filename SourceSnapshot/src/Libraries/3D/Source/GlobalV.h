...
extern g3s_vector _g3d_light_vec;   //  g3s_vector      <>      ; current light
                                    //  vector, computed from src and flag

extern g3s_vector _g3d_view_vec; //  g3s_vector      <>      ; current viewing
                                 //  vector, may have to be computed
                                 //  periodically

extern fix _g3d_ldotv; //  fix     ?       ; light vector dotted with view
                       //  vector (for specular only)
extern fix _g3d_sdotl; //  fix     ?       ; surface vector dotted with light
                       //  vector (for diffuse and spec)
extern fix _g3d_sdotv; //  fix     ?       ; surface vector dotted with view
                       //  vector (ostensibly jnorm)
