...
#define ome_light_flr_set(me_ptr, v) \
    ((me_ptr)->flags = (((me_ptr)->flags & ~OLD_MAP_F_LIGHT_MASK) | ((v) << OLD_MAP_F_LIGHT_SHF)))
#define ome_light_ceil_set(me_ptr, v) \
    ((me_ptr)->flags = (((me_ptr)->flags & ~OLD_MAP_C_LIGHT_MASK) | ((v) << OLD_MAP_C_LIGHT_SHF)))
...
#define ome_bits_rend_set(me_ptr, v) \
    (ome_flags_set(me_ptr, (ome_flags(me_ptr) & ~OLD_MAP_REND_MASK) | ((v) << OLD_MAP_REND_SHF)))
#define ome_bits_music_set(me_ptr, v) \
    (ome_flags_set(me_ptr, (ome_flags(me_ptr) & ~OLD_MAP_MUSIC_MASK) | ((v) << OLD_MAP_MUSIC_SHF)))
#define ome_bits_hit_set(me_ptr, v) \
    (ome_flags_set(me_ptr, (ome_flags(me_ptr) & ~OLD_MAP_HIT_MASK) | ((v) << OLD_MAP_HIT_SHF)))
#define ome_bits_deconst_set(me_ptr, v) \
    (ome_flags_set(me_ptr, (ome_flags(me_ptr) & ~OLD_MAP_DECONST_MASK) | ((v) << OLD_MAP_DECONST_SHF)))
#define ome_bits_mirror_set(me_ptr, v) \
