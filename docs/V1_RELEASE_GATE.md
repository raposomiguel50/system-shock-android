...
See [`PRESERVATION_SCOPE.md`](PRESERVATION_SCOPE.md).

## Accepted manual gates
...
- [ ] GitHub Actions QA build and semantic APK verification pass after the v1.0.0 metadata change.
...
- [ ] Public README, project website and ModDB are updated from pre-release to stable only after the signed artifact is published.
